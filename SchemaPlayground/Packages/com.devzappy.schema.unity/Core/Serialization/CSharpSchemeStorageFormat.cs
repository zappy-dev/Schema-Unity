...
"
            ...
            sb.Append(
$@"// <auto-generated>
// This file was generated by Schema based on the '{scheme.SchemeName}' data scheme.
...
{namespaceHeaderCode}
    /// <summary>
    /// Auto-generated strongly-typed wrapper for the '{scheme.SchemeName}' data scheme.
    /// </summary>
...
$@"     
        /// <summary>
        /// Strongly-typed constants for identifier values in '{scheme.SchemeName}'.
        /// </summary>
...
");
                         ...
                         .Where(a => a.ShouldPublish))
            {
                ...
                // TODO: Code gen settings should be defined maybe by the manifest? Do users want to be able to modify configs at runtime?
                // Schema dogfoods the Manifest, so it needs to be able to write to the scheme, but not sure if that's a broad use-case.
                ...
                string propertyDocSummary = !string.IsNullOrWhiteSpace(attributeDefinition.AttributeToolTip)
                    ...
                    : (codeGenAttributeSetters
                        ? $"Gets or sets the value of '{attributeName}'."
...
$@"     
        ...
        {{
            get => {getDataMethod};
            set => {nameof(EntryWrapper.DataScheme)}.SetDataOnEntry(CodeGenUtils.Context, {nameof(EntryWrapper.DataEntry)}, ""{attributeName}"", value);
        }}
");
                }
                else
...
");
            ...
            var resultCode = sb.ToString().ReplaceLineEndings();
            return res.Pass(resultCode);
        }
    }
}