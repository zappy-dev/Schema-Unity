...
namespace Schema.Core
{
    public abstract class ResultGenerator
    {
        ...
        internal SchemaResult Pass(string message = null, SchemaContext context = default) =>
        ...
        public SchemaResult<TResult> Fail<TResult>(string errorMessage, SchemaContext context = default) => 
            SchemaResult<TResult>.Fail(errorMessage, context);

        public SchemaResult<TResult> Pass<TResult>(TResult result, string successMessage = null, SchemaContext context = default) => 
            SchemaResult<TResult>.Pass(result: result, successMessage: successMessage, context: context);

        public SchemaResult<TResult> CheckIf<TResult>(bool conditional, TResult result, string errorMessage, string successMessage, SchemaContext context = default)
