...
public class TestDateTimeDataType
{
    ...
    {
        var dt = DateTime.Now;
        var result = _type.IsValidValue(Context, dt);
    ...
    {
        var result = _type.IsValidValue(Context, "not a date");
    ...
    public void ConvertData_ShouldSucceed_OnValidString()
    {
        ...
        var conversion = _type.ConvertValue(Context, dateStr);
    ...
    {
        var conversion = _type.ConvertValue(Context, "invalid date");
